...
window.trackerData = [
  ...
  {
    regex: /Summon Pierre in (\d+) [Dd]ifferent [Ss]pots/i,
    regexJP: /(\d+)ヶ所でカカシのピエールを呼び出す/,
    options: {
      counter: {
        icon: 'ocarina',
      },
